...
//  private $city = '北京';
  ...
  private $networkType = '经典网络';
    //config('aliyun.oss.access_id')           config('aliyun.oss.access_key')


//  private $AccessKeyId = 'LTAIOPQfAcmq82pi';
//  private $AccessKeySecret = 'A9ulbJSlQqphbrsXsFpcDn86l8SLWz';
...
//    );
  ...
  public static function publicUpload($bucketName, $ossKey, $filePath, $options = [])
  {
    ...
    $oss->ossClient->setBucket($bucketName);
      //dd($oss->ossClient->uploadFile($ossKey, $filePath, $options));
