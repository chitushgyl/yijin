...
class SysAddress extends Model{
    ...
    public function sysAddress(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
        return $this->hasOne('App\Models\SysAddress','id','parent_id');
    }

    public function address(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
        return $this->hasOne('App\Models\SysAddress','parent_id','id');
    }

    public function children(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
        return $this->hasMany('App\Models\SysAddress','parent_id','id');
    }
