...
class AttributeInfo extends Model{
    ...
    public function sysAttributeInfo(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
        return $this->hasOne('App\Models\SysAttributeInfo','self_id','parent_id');
    }

    public function children(){
        //参数：关联模型名称，外键，主键
        //如果主键是id可以省略
        return $this->hasMany('App\Models\SysAttributeInfo','parent_id','self_id');
    }
