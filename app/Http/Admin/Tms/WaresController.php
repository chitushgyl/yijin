...
//dd($button_info);
    ...
    /***    商品禁用/启用      /tms/wares/waresUseFlag
     */
    public function waresUseFlag(Request $request,Status $status){
