...
class PackageController  extends CommonController{
    ...
    public function packagePage(Request $request){
        ...
        $select=['self_id','create_user_name','create_time','group_name','package_name','cms_show'];
    ...
    /***    创建套餐      /sys/package/createPackage
     *      前端传递必须参数：
     *      前端传递非必须参数：
     */
